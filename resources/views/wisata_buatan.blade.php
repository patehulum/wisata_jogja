            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title2 text-center mb-90">
                        <h3>@lang('destinasi.artificial_tourist_destinations')</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                @foreach($destinasi as $wisata)
                    <div class="col-xl-4 col-md-4 col-lg-4">
                        <div class="single_master">
                            <div class="thumb">
                                <img src="{{url('/storage/images/destinasi/wisata_alam').'/'}}@foreach($wisata->images as $image){{$image->nama_file}}@endforeach
                                " alt="">
                            </div>
